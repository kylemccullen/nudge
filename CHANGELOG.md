...
### Added
- PWA home screen icon for iOS (apple-touch-icon and web manifest)

### Changed
- JWT session extended from 7 to 90 days

### Fixed
- iOS auto-zoom on login and search inputs (font size now 16px on mobile)
